...
var/list/global_sidormat_list = list(
	...
	"Handguns" = list(
		///////////////////////////// **Ïèñòîëåòû** /////////////////////////////////////
		new /datum/data/stalker_equipment("PMm",			"ÏÌì",				/obj/item/weapon/gun/projectile/automatic/pistol/pm,				3000,	ROOKIE),
		new /datum/data/stalker_equipment("TT",				"ÒÒ",				/obj/item/weapon/gun/projectile/automatic/pistol/tt,				3000,	ROOKIE),
		new /datum/data/stalker_equipment("Fort-12",		"Ôîðò-12",			/obj/item/weapon/gun/projectile/automatic/pistol/fort12,			6500,	ROOKIE),
		new /datum/data/stalker_equipment("PB1s",			"ÏÁÑ1ñ",			/obj/item/weapon/gun/projectile/automatic/pistol/pb1s,				4500,	ROOKIE),
		new /datum/data/stalker_equipment("SIG-Sauer P220",	"Ï-220",			/obj/item/weapon/gun/projectile/automatic/pistol/sip,				12500,	EXPERIENCED),
		new /datum/data/stalker_equipment("Colt M1911",		"Êîëüò",			/obj/item/weapon/gun/projectile/automatic/pistol/cora,				9000,	EXPERIENCED),
		new /datum/data/stalker_equipment("Beretta 92FS",	"Áåðåòòà",			/obj/item/weapon/gun/projectile/automatic/pistol/marta,				9000,	EXPERIENCED),
		new /datum/data/stalker_equipment("USP-match",		"ÞÑÏ-ìàò÷",			/obj/item/weapon/gun/projectile/automatic/pistol/usp_match, 		16000,	EXPERIENCED),
		new /datum/data/stalker_equipment("Colt Anaconda",	"Êîëüò Àíàêîíäà",	/obj/item/weapon/gun/projectile/revolver/anaconda,					25000,	EXPERIENCED),
		new /datum/data/stalker_equipment("Desert Eagle",	"Ä¸çåðò Èãë",		/obj/item/weapon/gun/projectile/automatic/pistol/desert,			30000,	EXPERIENCED)
		),
	...
	"Shotguns" = list(
		/////////////////////////////// **Äðîáîâèêè** /////////////////////////////////////
		new /datum/data/stalker_equipment("Sawn off",		"Îáðåç",			/obj/item/weapon/gun/projectile/revolver/bm16/sawnoff,				6000,	ROOKIE),
		new /datum/data/stalker_equipment("BM-16",			"ÁÌ-16",			/obj/item/weapon/gun/projectile/revolver/bm16,						10000,	ROOKIE),
		new /datum/data/stalker_equipment("TOZ-34",			"ÒÎÇ-34", 			/obj/item/weapon/gun/projectile/revolver/bm16/toz34,				15000,	ROOKIE),
		new /datum/data/stalker_equipment("Ithaca M37",		"Èòàêà Ì37",		/obj/item/weapon/gun/projectile/shotgun/ithaca,						20000,	EXPERIENCED),
		new /datum/data/stalker_equipment("Wincheaster-1300","Âèí÷åñòåð-1300",	/obj/item/weapon/gun/projectile/shotgun/chaser,						30000,	EXPERIENCED),
		new /datum/data/stalker_equipment("SPAS-12",		"ÑÏÀÑ-12",			/obj/item/weapon/gun/projectile/shotgun/spsa,						50000,	VETERAN)
		),

	"Rifles" = list(
		/////////////////////////////// **Âèíòîâêè** /////////////////////////////////////
		new /datum/data/stalker_equipment("Lee Enfield",	"Ëè Ýíôèëä",		/obj/item/weapon/gun/projectile/shotgun/boltaction/enfield,			15000,	ROOKIE),
		new /datum/data/stalker_equipment("Vintorez", 		"Âèíòîðåç",			/obj/item/weapon/gun/projectile/automatic/vintorez,					60000,	EXPERT)
		),

	"Melee Weapons" = list(
		/////////////////////////////// **Äðóãîå** /////////////////////////////////////
		new /datum/data/stalker_equipment("Kitchen Knife",		"Êóõîííûé íîæ",				/obj/item/weapon/kitchen/knife,												1500,	ROOKIE),
		new /datum/data/stalker_equipment("Tourist Knife",		"Íîæ òóðèñòà",				/obj/item/weapon/kitchen/knife/tourist,										4000,	ROOKIE),
		new /datum/data/stalker_equipment("Bayonet",			"Øòûê-íîæ",					/obj/item/weapon/kitchen/knife/bayonet,										7000,	ROOKIE),
		new /datum/data/stalker_equipment("Butcher's Cleaver",	"Òåñàê ì&#x44F;ñíèêà",		/obj/item/weapon/kitchen/knife/butcher,										10000,	ROOKIE)
		),

	"Ammo Boxes" = list(
		////////////////////////////////  Ïàòðîíû  /////////////////////////////////////////
		new /datum/data/stalker_equipment("9x18mm Box",				"Êîðîáêà 9õ18ìì",							/obj/item/ammo_box/stalker/b9x18,						1500,	ROOKIE),
	...
	"Suits" = list(
		///////////////////////////////  Áðîíÿ  /////////////////////////////////////////
		new /datum/data/stalker_equipment("Leather jacket",				"Êîæàíêà",							/obj/item/clothing/suit/hooded/kozhanka,					5000,	ROOKIE),
		new /datum/data/stalker_equipment("White leather jacket",		"Áåëà&#x44F; êîæàíêà",				/obj/item/clothing/suit/hooded/kozhanka/white,				5000,	ROOKIE),
		new	/datum/data/stalker_equipment("Bandit jacket",				"Áàíäèòñêà&#x44F; êîæàíêà",			/obj/item/clothing/suit/hooded/kozhanka/banditka,			6000,	ROOKIE,		faction = "Bandits"),
		new	/datum/data/stalker_equipment("Army suit",					"Àðìåéñêèé êîìáèíåçîí",				/obj/item/clothing/suit/army,								15000,	ROOKIE,		faction = "Army"),
		new /datum/data/stalker_equipment("\"Sunrize\"",				"Êîìáèíåçîí \"Çàð&#x44F;\"",		/obj/item/clothing/suit/hooded/kombez,						33000,	ROOKIE,		faction = "Loners"),
		new /datum/data/stalker_equipment("Merc suit",					"Êîìáèíåçîí íà¸ìíèêîâ",				/obj/item/clothing/suit/hooded/kombez/mercenary,			25000,	ROOKIE,		faction = "Mercenaries"),
		new /datum/data/stalker_equipment("Bandit suit",				"Êîìáèíåçîí áàíäèòîâ",				/obj/item/clothing/suit/hooded/kombez/kombez_bandit,		25000,	ROOKIE,		faction = "Bandits"),
		new /datum/data/stalker_equipment("Black trenchcoat",			"Ò¸ìíûé ïëàù",						/obj/item/clothing/suit/hooded/kozhanka/banditka/coat,		12500,	ROOKIE,		faction = "Bandits"),
		new /datum/data/stalker_equipment("Brown trenchcoat",			"Ïëàù",								/obj/item/clothing/suit/hooded/kozhanka/banditka/coat/brown,12500,	ROOKIE),
		...
		new /datum/data/stalker_equipment("PSZ-9D",						"ÏÑÇ-9Ä",							/obj/item/clothing/suit/psz9d,								60000,	VETERAN,	faction = "Duty"),
		new /datum/data/stalker_equipment("SKAT-9M",					"ÑÊÀÒ-9Ì",							/obj/item/clothing/suit/skat,								75000,	VETERAN),
		new	/datum/data/stalker_equipment("PSZ-9Md",					"ÏÑÇ-9Ìä",							/obj/item/clothing/suit/hooded/sealed/psz9md,				75000,	VETERAN,	faction = "Duty"),
		new	/datum/data/stalker_equipment("SSP-99 Ecologist",			"ÑÑÏ-99 Ýêîëîã",					/obj/item/clothing/suit/hooded/sealed/ecolog,				75000,	EXPERT),
		new	/datum/data/stalker_equipment("SSP-99M Ecologist",			"ÑÑÏ-99Ì Ýêîëîã",					/obj/item/clothing/suit/hooded/sealed/ecologm,				100000,	EXPERT),
		new	/datum/data/stalker_equipment("SEVA",						"ÑÅÂÀ",								/obj/item/clothing/suit/hooded/sealed/seva,					125000,	EXPERT),
		new	/datum/data/stalker_equipment("Exoskeleton",				"Ýêçîñêåëåò",						/obj/item/clothing/suit/hooded/sealed/exoskelet,			150000,	EXPERT,		assortment_level = 500)
		),

	"Masks and Helmets" = list(
		////////////////////////////	Ìàñêè, Øëåìû	/////////////////////////////////////
		new /datum/data/stalker_equipment("Gasmask",					"Ïðîòèâîãàç",					/obj/item/clothing/mask/gas/stalker,							7500,	ROOKIE),
		new /datum/data/stalker_equipment("Merc gasmask",				"Ïðîòèâîãàç íàåìíèêîâ",			/obj/item/clothing/mask/gas/stalker/mercenary,					7500,	ROOKIE),
		new /datum/data/stalker_equipment("Steel helmet",				"Ñòàëüíàÿ êàñêà",				/obj/item/clothing/head/steel,									7500,	ROOKIE),
		new /datum/data/stalker_equipment("Light tactical helmet",		"Ëåãêèé òàêòè÷åñêèé øëåì",		/obj/item/clothing/head/hardhat/tactical/light,					12500,	EXPERIENCED),
		new /datum/data/stalker_equipment("Tactical helmet",			"Òàêòè÷åñêèé øëåì",				/obj/item/clothing/head/tacticalhelmet,							25000,	EXPERIENCED),
		new /datum/data/stalker_equipment("Assault helmet",	    		"Øòóðìîâîé øëåì",				/obj/item/clothing/head/assaultmerc,							30000,	EXPERIENCED,	faction = "Mercenaries"),
		new /datum/data/stalker_equipment("Sphera-M12",			 		"Ñôåðà-Ì12",					/obj/item/clothing/head/spheram,								30000,	EXPERIENCED),
		new /datum/data/stalker_equipment("SKAT-9M (helmet)",			"ÑÊÀÒ-9Ì (øëåì)",				/obj/item/clothing/head/skathelmet,								40000,	VETERAN)
		),
	...
	"Misc" = list(
		/////////////////////////////////	Äðóãîå	/////////////////////////////////////////////
		new /datum/data/stalker_equipment/stalker_pda("KPK",					"ÊÏÊ",													/obj/item/device/stalker_pda,								4000,	ROOKIE),
		new /datum/data/stalker_equipment("Radio",								"Ðàöè&#x44F;",											/obj/item/device/radio,										15000,	ROOKIE),
